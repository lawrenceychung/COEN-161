...
(function(){
	...
	class Snake {
		...
		isFoodEaten() {
			let snakeTop = parseInt(this.snakeParts[0].compStyle.top);
			let snakeLeft = parseInt(this.snakeParts[0].compStyle.left);

			let foodTop = parseInt(document.getElementById("snake3").style.top);
			let foodLeft = parseInt(document.getElementById("snake3").style.left);
